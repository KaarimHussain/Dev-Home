    ...
    return (
        <>
            <header className="w-full fixed top-0 left-0 z-50 bg-transparent">
                <div className="container mx-auto px-5 md:px-10 lg:px-20 xl:px-32 py-2">
                    <div className="flex items-center justify-between lg:grid lg:grid-cols-3 lg:gap-4">
                        {/* Logo - Left Side */}
                        <div className="flex items-center">
                            <a href="/">
                                <Image src={Logo} alt="Kaarim Hussain Logo" className="aspect-square w-13 object-contain" />
                            </a>
                        </div>
                        ...
                        <nav className="hidden lg:flex gap-6 items-center justify-center">
                            {links.map((data, index) => (
                                <a
                                    className="text-white/70 hover:text-white font-light transition-all duration-200 whitespace-nowrap text-sm"
                                    href={data.href}
                                    key={index}
                                >
                                    {data.label}
